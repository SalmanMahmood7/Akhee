  ...
  return (
    <footer className="relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
            ...
            <div className="space-y-6">
              <h4 className="text-lg font-semibold text-[#1e3a8a] mb-4">Quick Links</h4>
              <ul className="space-y-3">
                <li>
                  <a href="/services" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    Services
                  </a>
                </li>
                <li>
                  <a href="/work" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    Work
                  </a>
                </li>
                <li>
                  <a href="/about" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    About
                  </a>
                </li>
                <li>
                  <a href="/insights" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    Insights
                  </a>
                </li>
              </ul>
            ...
            {/* Column 2 */}
            <div className="space-y-6">
              <h4 className="text-lg font-semibold text-[#1e3a8a] mb-4">Company</h4>
              <ul className="space-y-3">
                <li>
                  <a href="/careers" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    Careers
                  </a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-600 hover:text-orange-600 transition-colors duration-200 font-medium">
                    Contact Us
                  </a>
                </li>
                <li>
            ...
            <div className="md:col-span-2 space-y-6">
              <h3 className="text-2xl 1366:text-xl font-bold">
              ...
              <div className="space-y-4 flex flex-col items-center md:items-start">
                ...
                <div className="flex items-center space-x-4 pt-2">
                  ...
                  <a 
                    href="https://www.linkedin.com/company/akhee/" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 hover:bg-[#f97316] text-gray-600 hover:text-white rounded-full transition-all duration-300 hover:scale-110"
                  >
                    <Linkedin className="w-4 h-4" />
                  </a>
                  <a 
                    href="https://www.facebook.com/akhee/" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 hover:bg-[#f97316] text-gray-600 hover:text-white rounded-full transition-all duration-300 hover:scale-110"
                  >
                  ...
                  <a 
                    href="https://www.instagram.com/akhee/" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 hover:bg-[#f97316] text-gray-600 hover:text-white rounded-full transition-all duration-300 hover:scale-110"
                  >
      ...
      <div className="border-t border-gray-300">
        <div className="max-w-7xl 1366:max-w-6xl mx-auto px-6 1366:px-8 py-4">
          <div className="flex flex-col-reverse md:flex-row justify-between items-center space-y-reverse space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center justify-center md:justify-start space-y-2 md:space-y-0 md:space-x-6 1366:space-x-4 text-sm 1366:text-xs text-gray-500 text-center md:text-left">
              <span>© Copyright 2025 Akhee. All Rights Reserved</span>
            ...
            {/* Akhee Logo - Shows first on mobile due to flex-col-reverse */}
            <div className="flex items-center">
              <img 
                src="/AKHEE LOGO-09.svg" 
                alt="Akhee" 
