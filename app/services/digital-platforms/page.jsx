  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-white">
        ...
        <section className="relative z-10 bg-gradient-to-br from-blue-50 via-white to-orange-50 overflow-hidden" style={{paddingTop: '30px', paddingBottom: '30px'}}>
          ...
          <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl relative z-10">
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                <span className="text-[#1e3a8a]">Our Platform</span> <span className="text-[#f97316]">Solutions</span>
              </h2>
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-24">
              ...
              <div className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-6 space-y-4">
                  <h3 className="text-2xl font-bold text-[#1e3a8a]">ERP System Implementation</h3>
                  ...
                  <div className="pt-4">
                    <button 
                      ...
                      className="text-[#1e3a8a] font-semibold flex items-center group/btn"
                    >
                      Learn More
              ...
              <div className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-6 space-y-4">
                  <h3 className="text-2xl font-bold text-[#1e3a8a]">CRM Platform Development</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-6 space-y-4">
                  <h3 className="text-2xl font-bold text-[#1e3a8a]">Content Management Solutions</h3>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div className="lg:col-span-3 space-y-8">
                  <div>
                    <h2 className="text-4xl md:text-5xl font-bold text-[#1e3a8a] leading-tight mb-6">
                      <span className="text-[#f97316]">Navigate Your Growth</span> <span className="text-[#1e3a8a]">with Strategic Platform Solutions</span>
                    </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-lg font-bold text-[#1e3a8a] mb-2">Expert Advisory</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-lg font-bold text-[#1e3a8a] mb-2">Optimized Solutions</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-lg font-bold text-[#1e3a8a] mb-2">Strategic Design</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-lg font-bold text-[#1e3a8a] mb-2">Success-Focused</h4>
            ...
            <div style={{paddingTop: '30px', paddingBottom: '30px'}}>
              <div className="text-center mb-10">
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  <span className="text-[#1e3a8a]">Platform</span>{" "}
            ...
            <div style={{paddingTop: '30px', paddingBottom: '30px'}}>
              ...
              <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-12 lg:mb-10">
                {[
                  {
